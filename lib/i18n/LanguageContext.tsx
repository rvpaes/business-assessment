...
export const translations = {
  "pt-BR": {
    ...
    lakeSelectionTitle: "Qual o Lake será realizado o assessment?",
    lakeSelectionSub: "Selecione a plataforma de dados de origem para auditoria:",
    lakeBigQuery: "Google BigQuery",
    lakeBigQueryBadge: "Ativo • Nativo",
    lakeBigQueryDesc: "Auditoria nativa de datasets, INFORMATION_SCHEMA, descrições e Dataplex.",
    lakeDatabricks: "Databricks",
    lakeSnowflake: "Snowflake",
    lakeComingSoon: "Em breve",
    downloadScriptTitle: "Script de Assessment (Jupyter Notebook)",
    downloadScriptDesc: "Baixe e execute este notebook no Google BigQuery Studio ou Colab Enterprise do cliente para extrair esquemas com segurança (sem ler dados sensíveis) e gerar o pacote .ZIP.",
    downloadScriptBtn: "Baixar Notebook de Assessment (.ipynb)",
    downloadScriptSuccess: "Download iniciado! Importe no BigQuery Studio do cliente.",
    downloadScriptSize: "152 KB • BigQuery Studio Ready",
  ...
  "en-US": {
    ...
    lakeSelectionTitle: "Which Data Lake will the assessment be run on?",
    lakeSelectionSub: "Select the source data platform for audit:",
    lakeBigQuery: "Google BigQuery",
    lakeBigQueryBadge: "Active • Native",
    lakeBigQueryDesc: "Native audit of datasets, INFORMATION_SCHEMA, descriptions, and Dataplex.",
    lakeDatabricks: "Databricks",
    lakeSnowflake: "Snowflake",
    lakeComingSoon: "Coming soon",
    downloadScriptTitle: "Assessment Script (Jupyter Notebook)",
    downloadScriptDesc: "Download and execute this notebook in the customer's Google BigQuery Studio or Colab Enterprise to safely extract schemas (no sensitive data read) and generate the .ZIP package.",
    downloadScriptBtn: "Download Assessment Notebook (.ipynb)",
    downloadScriptSuccess: "Download started! Import into the customer's BigQuery Studio.",
    downloadScriptSize: "152 KB • BigQuery Studio Ready",
  ...
  "es-ES": {
    ...
    lakeSelectionTitle: "¿En qué Data Lake se realizará la evaluación?",
    lakeSelectionSub: "Seleccione la plataforma de datos de origen para la auditoría:",
    lakeBigQuery: "Google BigQuery",
    lakeBigQueryBadge: "Activo • Nativo",
    lakeBigQueryDesc: "Auditoría nativa de datasets, INFORMATION_SCHEMA, descripciones y Dataplex.",
    lakeDatabricks: "Databricks",
    lakeSnowflake: "Snowflake",
    lakeComingSoon: "Próximamente",
    downloadScriptTitle: "Script de Assessment (Jupyter Notebook)",
    downloadScriptDesc: "Descargue y ejecute este notebook en Google BigQuery Studio o Colab Enterprise del cliente para extraer esquemas de forma segura (sin leer datos sensibles) y generar el archivo .ZIP.",
    downloadScriptBtn: "Descargar Notebook de Assessment (.ipynb)",
    downloadScriptSuccess: "¡Descarga iniciada! Importe en BigQuery Studio del cliente.",
    downloadScriptSize: "152 KB • Listo para BigQuery Studio",
